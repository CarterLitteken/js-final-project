    ...
    <div className='container-fluid'>
      ...
      <div className='row mt-4' id='searchItems'>
        ...
        <div className='col-md-4 mt-3'>
          <button type='button' className='btn btn-lg btn-primary border-3 border-secondary border-opacity-10' onClick={searchItems}>Search Items <FontAwesomeIcon icon={faSearch}/></button>
        </div>
